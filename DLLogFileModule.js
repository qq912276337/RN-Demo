...
/* 日志输出模式 */
if(typeof DLLogFileMode == "undefined"){
    var DLLogFileMode = {};
    DLLogFileMode.console = 0;
    DLLogFileMode.file = 1;
    DLLogFileMode.all = 2;
}
...
export default class DLLogFileModule {
    ...
    constructor(options = {}) {
        ...
        this.logMode = options.logMode || DLLogFileMode.all;
    ...
    log(arg){
        ...
        switch(this.logMode) {
            case DLLogFileMode.console:
                console.log(arg);
                break;
            case DLLogFileMode.file:
