/**
 * Created by sml2 on 2017/10/11.
 */
// import React, { Component, PropTypes } from 'react';
// import { AppRegistry, Text, View } from 'react-native';
//
// var QQLoginView = require('./LoginView');
//
...
// ES5
 var DLShareView = React.createClass({
    // 设置默认值,固定值()
    getDefaultProps(){
        return{
...
module.exports = DLShareView;
// AppRegistry.registerComponent('DLShareView', () => DLShareView);
